...
public class FragmentCreateGasSensor extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_create_gas_sensor, parent, false);
        AppCompatButton createBtn = view.findViewById(R.id.createGasSensorButton);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.createGasSensorButton) {
            updateValues();
